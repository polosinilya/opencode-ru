...
const options = {
  port: {
    ...
    describe: t("port to listen on"),
    default: 0,
  },
  hostname: {
    type: "string" as const,
    describe: t("hostname to listen on"),
    default: "127.0.0.1",
  },
  mdns: {
    type: "boolean" as const,
    describe: t("enable mDNS service discovery (defaults hostname to 0.0.0.0)"),
    default: false,
  },
  "mdns-domain": {
    type: "string" as const,
    describe: t("custom domain name for mDNS service (default: opencode.local)"),
    default: "opencode.local",
  },
  cors: {
    type: "string" as const,
    array: true,
    describe: t("additional domains to allow for CORS"),
    default: [] as string[],
  },
}
